...
<x-filament-forms::field-wrapper label="Free Shipping Amount" statePath="free_shipping_amount"
    hint="Enter free shipping amount">
    <input type="text" id="free_shipping_amount" name="free_shipping_amount"
        class="w-full rounded-lg border-gray-300 bg-white text-gray-900 shadow-sm 
                                focus:border-primary-500 focus:ring-1 focus:ring-primary-500
                                dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 dark:placeholder-gray-500"
...
<x-filament-forms::field-wrapper label="Admin Shipping" statePath="admin_shipping"
    hint="Enter admin shipping phone">
    ...
    <x-filament-forms::field-wrapper label="Admin Terms & Conditions" statePath="admin_terms_conditions"
        hint="Enter admin terms & conditions">
