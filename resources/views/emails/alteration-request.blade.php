...
<head>
    ...
    <style>
        * {
        ...
        .email-header {
            background: linear-gradient(135deg, #01949a 0%, #016b6f 100%);
            color: #ffffff;
            padding: 30px 20px;
            text-align: center;
        }
        ...
        .action-button:hover {
            background: linear-gradient(135deg, #016b6f 0%, #014d50 100%);
                    ...
                    <div class="info-row">
                        ...
                        <div class="info-value">
                            <a href="mailto:{{ $alteration->email }}"
                                style="color: #01949a; text-decoration: none;">{{ $alteration->email }}</a>
                        </div>
                    </div>
                    <div class="info-row">
                        ...
                        <div class="info-value">
                            <a href="tel:{{ $alteration->phone }}"
                                style="color: #01949a; text-decoration: none;">{{ $alteration->phone }}</a>
                        </div>
                    </div>
                    <div class="info-row">
