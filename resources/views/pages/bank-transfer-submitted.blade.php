@section('title', 'Payment Submitted | ' . config('app.name'))
    ...
    <div class="success-container">
        <div class="success-card">
            ...
            <div class="success-header">
                ...
                <h1 class="text-light">Payment Proof Submitted!</h1>
                <p>Order #{{ $order->id }}</p>
            </div>
            ...
            <div class="success-body">
                @if (session('success'))
                    <div class="info-box" style="background: #d1fae5; border-color: #10b981;">
                        ...
                        <p style="color: #047857;">{{ session('success') }}</p>
                    </div>
                @endif

                <div class="info-box">
                    <h3>📋 What Happens Next?</h3>
                    <p>Your payment receipt has been submitted successfully. Our team will review it within 12-24 hours
                ...
                <div class="order-details">
                    ...
                    <div class="detail-row">
                        ...
                        <span class="detail-value" style="color: #10b981;">${{ number_format($order->total, 2) }}</span>
                    </div>
                    <div class="detail-row">
                    ...
                    <div class="detail-row">
                        ...
                        <span class="detail-value">
                            <a href="{{ route('payment.bank-transfer.download', ['order' => $order->id]) }}"
                ...
                <div class="action-buttons">
                    <a href="{{ route('homepage') }}" class="btn-primary" style="background-color:#f59e0b !important;">
                        Continue Shopping
                    </a>
                    @auth
