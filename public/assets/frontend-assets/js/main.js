...
(function ($) {
    ...
    var Animation = function ({ offset } = { offset: 10 }) {
        ...
        function isElementOnScreen(element) {
            ...
            var elementBottom =
                elementRect.bottom -
                    parseInt(element.dataset.animationOffset) ||
                elementRect.bottom;
    ...
    $(window).on("scroll", function () {
        var $target = $(".sticky-header-next-sec");
    ...
    $(".cart-qty-plus-minus .ec_cart_qtybtn .ec_qtybtn").on(
        ...
        function () {
            ...
            var CartQtyoldValue = $cartqtybutton
                .parent()
                .parent()
                .find("input")
                .val();
